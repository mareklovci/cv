...
%---------------------------------------------------------
    \cventry
    {Back-end vývojář} % Job title
    {Unicorn a.s.} % Organization
    {Plzeň, Česká republika} % Location
    {Červenec 2018 - Září 2019} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Vývoj informačních systémů pro správu přeshraničního přenosu elektrické energie, které využívají správci přenosových soustav.}
        \item {Správa informačních systémů pro tzv. \enquote{interconnectory}}
      \end{cvitems}
    }
    
%---------------------------------------------------------
    \cventry
    {Front-end vývojář} % Job title
    {KETNET s.r.o.} % Organization
    {Tachov, Česká republika} % Location
    {Červen 2016 - Srpen 2016} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Vytváření webových stránek dle grafického návrhu s použitím interního systému pro správu obsahu.}
        \item {Konzultace požadavků se zákazníkem.}
      \end{cvitems}
    }
