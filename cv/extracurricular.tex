...
%---------------------------------------------------------
  \cventry
    ...
    {Student Support Centre (FAV ZČU)} % Organization/group
    {Plzeň} % Location
...
%---------------------------------------------------------
  \cventry
    {Vedoucí nástrojové sekce} % Affiliation/role
    {Orchestr Ambito Základní umělecké školy, Plzeň, Sokolovská 54} % Organization/group
    {Plzeň} % Location
    {Září 2017 - současnost} % Date(s)
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
...
%---------------------------------------------------------
  \cventry
    {Vedoucí nástrojové sekce} % Affiliation/role
    {Dechový orchestr mladých ZUŠ Tachov} % Organization/group
    {Tachov} % Location
    {Září 2005 - současnost} % Date(s)
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
        \item {Zaučuji nové hráče a poskytuji podporu méně zkušeným členům.}
      \end{cvitems}
